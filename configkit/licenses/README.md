...
ConfigKit itself is LGPL-3 (see COPYING.LESSER at the repo root). It carries code
from two other projects, whose licences travel with the shipped zip:
...
| ConfigLib | the config core is derived from it | CC0 1.0 — no notice required, credited in each file header |
